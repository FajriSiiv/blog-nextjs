...
export default async function SlugBlogPage({
  params,
}: {
    ...
    <>
      <div className="flex justify-between items-center pt-10 pb-5">
        <div className="flex items-center gap-x-3 ">
          ...
          <h1 className="ml-1 text-xl font-semibold text-nowrap">Go Back</h1>
        </div>
      ...
      <div className="flex flex-col items-center justify-center mb-10">
        <div className="m-auto w-full text-center md:w-7/12">
          ...
          <h1 className="mb-5 text-lg font-bold md:text-2xl tracking-tight">
            {data.title}
          </h1>
